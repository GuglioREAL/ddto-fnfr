...
return graphics.newSprite(
    images.icons,
	{
		...
		{x = 0, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 25: Sayori
		{x = 150, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 26: Sayori Losing
		{x = 300, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 27: Natsuki
		{x = 450, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 28: Natsuki Losing
		{x = 600, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 29: Yuri
		{x = 750, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 30: yuri Losing
		{x = 900, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 31: Yuri-C
		{x = 1050, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 32: yuri-C Losing
		{x = 1200, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 33: Monika
		{x = 1350, y = 450, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 34: Monika Losing
		{x = 0, y = 600, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 35: BMonika
		{x = 150, y = 600, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 36: BMonika Losing
		{x = 600, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0}, -- 37: Monikap
		{x = 750, y = 300, width = 150, height = 150, offsetX = 0, offsetY = 0, offsetWidth = 0, offsetHeight = 0} -- 38: Monikap Losing
	},
	{
		...
		["monikap"] = {start = 37, stop = 37, speed = 0, offsetX = 0, offsetY = 0},
		["monikap losing"] = {start = 38, stop = 38, speed = 0, offsetX = 0, offsetY = 0},
		["senpai"] = {start = 23, stop = 23, speed = 0, offsetX = 0, offsetY = 0},
		["spirit"] = {start = 24, stop = 24, speed = 0, offsetX = 0, offsetY = 0},
		["sayori"] = {start = 25, stop = 25, speed = 0, offsetX = 0, offsetY = 0},
		["sayori losing"] = {start = 26, stop = 26, speed = 0, offsetX = 0, offsetY = 0},
		["natsuki"] = {start = 27, stop = 27, speed = 0, offsetX = 0, offsetY = 0},
		["natsuki losing"] = {start = 28, stop = 28, speed = 0, offsetX = 0, offsetY = 0},
		["yuri"] = {start = 29, stop = 29, speed = 0, offsetX = 0, offsetY = 0},
		["yuri losing"] = {start = 30, stop = 30, speed = 0, offsetX = 0, offsetY = 0},
		["yuri-c"] = {start = 31, stop = 31, speed = 0, offsetX = 0, offsetY = 0},
		["yuri-c losing"] = {start = 32, stop = 32, speed = 0, offsetX = 0, offsetY = 0},
		["monika"] = {start = 33, stop = 33, speed = 0, offsetX = 0, offsetY = 0},
		["monika losing"] = {start = 34, stop = 34, speed = 0, offsetX = 0, offsetY = 0},
		["bmonika"] = {start = 35, stop = 35, speed = 0, offsetX = 0, offsetY = 0},
		["bmonika losing"] = {start = 36, stop = 36, speed = 0, offsetX = 0, offsetY = 0}
	},
	"boyfriend",
	false
)
